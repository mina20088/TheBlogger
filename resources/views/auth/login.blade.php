<x-app-layout class="grid place-content-center place-items-center h-screen">
    @include('partials.__auth-head',[
            'title'=>'Login',
            'quote'=>'Welcome back! We are happy you have returned to share your thoughts, stories, and ideas with our community of creative writers and thinkers. Log in now to connect with fellow bloggers and be heard.'
        ])
    <form class='space-y-6 xl:w-96' action="#" method="post">
        @csrf
        <div>
        ...
        <div class="flex justify-between">
            ...
            <a href="#" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="text-sm text-blue-700 hover:underline dark:text-blue-500" type="button">Lost Password?</a>
