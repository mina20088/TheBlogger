<ul class=" flex w-full navbar-nav">
    <li class="nav-item max-sm:hidden basis-9/12">
        <form>
            ...
            <div class="relative">
                ...
                <button type="submit" class="text-white absolute right-0 bottom-0 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
            </div>
        </form>
    </li>
    <li class=" flex justify-center items-center basis-3/12 flex-row nav-item">
        ...
        <div class="flex max-sm:basis-full">
            <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdownAvatarName" class="flex items-center text-sm font-medium text-gray-900 rounded-full hover:text-blue-600 dark:hover:text-blue-500 md:mr-0 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-white" type="button">
                ...
                <img class="w-8 h-8 mr-2 rounded-full" src="{{ Vite::asset('resources/images/profile-picture-3.jpg') }}" alt="user photo">
                Bonnie Green
