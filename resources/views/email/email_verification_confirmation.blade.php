...
<head>
  ...
  <![endif]-->
  <title>Verification Success Email</title>
  <style>
    h1 {
      font-size: 30px;
      line-height: 36px;
...
<body style="margin: 0; width: 100%; background-color: #fff; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word">
  <div align="center" role="article" aria-roledescription="email" lang="en" class="sm-px-4" aria-label="Verification Success Email" style="background-color: #fff">
