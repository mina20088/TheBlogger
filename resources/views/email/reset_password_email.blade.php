...
<body style="margin: 0; width: 100%; background-color: #fff; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word">
  <div align="center" role="article" aria-roledescription="email" lang="en" class="sm-px-4" aria-label="Rest Password" style="background-color: #fff">
          ...
          <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
            <tr>
              <td style="text-align: center">
                <img src="images/logo.png" alt="logo" style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0">
              </td>
            </tr>
            <tr>
              <td class="sm-px-4" style="max-width: 0; padding-left: 32px; padding-right: 32px">
                ...
                <div style="margin-bottom: 40px; margin-top: 40px; text-align: center">
                  <a href="{{  route('password.reset',['token'=> $token,'email'=>$user->email]) }}" style="text-decoration: underline; align-items: center; border-radius: 8px; background-color: #1d4ed8; padding: 24px; text-align: center; font-weight: 700; color: #fff; text-decoration-line: none">
                    Reset Password
                  </a>
                ...
                <p class="font-size: 16px; line-height: 24px; margin: 12px 0 32px; color: #374151;">
                  Note: Please note that the link will be expired after 30 min
                </p>
                <p style="font-size: 16px; line-height: 24px; margin: 12px 0 32px; color: #374151;">
