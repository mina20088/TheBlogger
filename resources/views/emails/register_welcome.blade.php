...
<x-layouts.email-layout :$message>
    ...
    <main>
        ...
        <p style="color: #4B5563;"> We are thrilled to welcome you to <span style="color: #1C64F2;">TheBlogger</span>
            , where your journey as a blogger begins. Whether you're
            an experienced writer or just starting out, we're excited to have you join our vibrant community of bloggers.</p>
        <p style="color: #4B5563;"> Here at <span style="color: #1C64F2;">TheBlogger</span>
            , we believe in the power of words and the unique stories each of us has to share.
        ...
        <p style="color: #4B5563;"> Here are a few things you can look forward to on our platform:</p>
        <ul style="list-style-type: decimal">
            <li style="margin-top: 20px; color: #64748b">
                <span style="font-weight: 700">User-Friendly Interface:</span> We've designed our platform to be intuitive and easy to navigate, so you can focus on what you do best – writing and sharing your content.
            </li>
            <li style="margin-top: 20px; color: #64748b;">
        ...
        <p style="color: #4B5563;"> Thank you for choosing <span style="color: #1C64F2;">TheBlogger</span>
            as your platform for sharing your thoughts and creativity. We look forward to seeing your blog posts, learning from your experiences, and connecting with you in this exciting journey of blogging.</p>
