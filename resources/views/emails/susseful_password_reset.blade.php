...
<div align="center" role="article" aria-roledescription="email" lang="en" class="sm:px-4 bg-white"
                ...
                <table class="w-full" cellpadding="0" cellspacing="0" role="none">
                    ...
                    <tr>
                        <td class="px-8 sm:px-4 max-w-0">
                            ...
                            <h2 class="text-gray-700">Hi <span class="text-blue-600">{{$user->username}}}</span>,</h2>
                            <script>
                                module.exports = {
                            ...
                            <p class="mt-3 text-gray-700 undefined">
                                We are contacting you to let you know that your password for The Blogger has been changed successfully
                                on {{ $created_at }}.
                                <script>
                                    module.exports = {
                                        class: props.class | 'mt-3 font-normal text-gray-700'
                            ...
                            <p class="mt-3 text-gray-700 undefined">
                                Please remember to keep your password confidential and do not share it with anyone. If you feel your
                                account has been compromised, notify us right away so we can take appropriate security measures.
                                <script>
                                    module.exports = {
                                        class: props.class | 'mt-3 font-normal text-gray-700'
                                    }
