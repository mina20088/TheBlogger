<div class="max-w-full mx-auto p-10">
    ...
    <form wire:submit.prevent='save'>
        ...
        <div class="mb-6">
            ...
            <input id="excrept" type="text" id="form.excrept" wire:model='form.excrept' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            @error('form.excrept')
              <span class="text-red-600">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-6">
            ...
            <trix-editor input="x" wire:model='form.content' class='block h-[30rem] p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' input="x"></trix-editor>
            @error('form.content')
             <span class="text-red-600">{{ $message }}</span>
           @enderror
        </div>
